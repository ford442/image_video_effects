// Liquid Rainbow Glass - Thick translucent layers of flowing color with 
// refraction-like effects. Colors blend and swirl like oil in water but extremely 
// bright and saturated. Chromatic dispersion at edges. Mouse stirs the liquid.
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
  ...
  let ribbonColor = liquidRainbow(ribbonNoise * 4.0 + t * 0.1 + colorShift);
