...
//  Category: generative
//  Description: Iterated function system rendering a 3D Sierpinski
//    tetrahedron projection. Uses the chaos game algorithm with
//    thousands of iterations per pixel, creating intricate point-cloud
//    renders with depth shading. Mouse rotates the 3D view.
