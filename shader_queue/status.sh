...
echo "   1. 🔄 Bismuth Crystal Citadel  ← IN PROGRESS"
echo "      Branch: feat/new-bismuth-shader-plan-17925881371107706036"
echo "      Action: Generate WGSL + JSON → Commit → Push → Merge"
echo ""
...
echo "   3. ⏳ Celestial Forge          ← PENDING"
echo "      Branch: new-shader-plan-celestial-forge-18393159539870047868"
echo "      Action: Generate WGSL + JSON after Bismuth done"
echo ""
...
echo "   ./shader_queue/next_pr.sh         # Advance to next PR"
