...
//  Features: advanced-alpha, holographic, failure-effect, glitch, upgraded-rgba
//  Complexity: Medium
//  Created: 2026-05-23
//  Upgraded: 2026-05-23
// ═══════════════════════════════════════════════════════════════════
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let holographicIntensity = u.zoom_params.y * (1.0 + treble * 0.3);
    let depthWeight = u.zoom_params.z;
    let flickerSpeed = u.zoom_params.w * 20.0 * (1.0 + mids * 0.5);
