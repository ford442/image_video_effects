...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    // Critical line landscape: sigma = 0.5, t varies across screen
    ...
    // Approximate zeta with audio-driven term count
    ...
    // Semantic alpha: stronger where zeta magnitude is high
    let alpha = clamp(height * 0.7 + ridge * 0.3 + bass * 0.1, 0.0, 1.0);
