...
fn main(@builtin(global_invocation_id) gid: vec3<u32>) {
  ...
  // ✨ GEMINI UPGRADE: Sense-and-turn logic
  ...
  // ✨ GEMINI UPGRADE: Nutrient interaction
  ...
  // ✨ GEMINI UPGRADE: Trail decay and blending
