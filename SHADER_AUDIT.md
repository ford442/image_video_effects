...
|----------|------|--------|
| 🔴 High | Fix `spectral-vortex.wgsl` binding names | 15 min |
| 🔴 High | Fix `rainbow-cloud.wgsl` persistence parameter | 5 min |
| 🟡 Medium | Test all new psychedelic shaders | 30 min |
| 🟡 Medium | Fix `quantum-wormhole.wgsl` void threshold | 10 min |
| 🟢 Low | Optimize `neural-resonance.wgsl` texture samples | 30 min |
| 🟢 Low | Add `flashIntensity` param to `chromatic-crawler.wgsl` | 15 min |
| 🟢 Low | Standardize hash functions across all shaders | 2 hours |
