...
- Name: wasm-renderer.smoke.spec.ts >> WASM renderer collects performance metrics
- Location: tests/wasm-renderer.smoke.spec.ts:276:5
...
Error: page.evaluate: TypeError: Failed to execute 'decode' on 'TextDecoder': The provided ArrayBuffer value must not be resizable
    ...
    at eval (eval at evaluate (:303:30), <anonymous>:4:194)
```