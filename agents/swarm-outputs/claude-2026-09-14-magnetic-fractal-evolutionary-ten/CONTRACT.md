# Magnetic / fractal / evolutionary generative ten — agent contract (2026-09-14)
...
Two **native** ideas each — grounded in the shader's own subject (magnetohydrodynamics, kelp biomechanics, Mandelbox fold math, soft-body mechanics, soap-film physics, planetary geodynamics, evolutionary ecology, flocking dynamics…), not generic noise/bloom/IQ-palette overlays. Keep identity and existing core functions. No new springs. No replacing the motif.
...
## Card
Write an Idea Card section for each of your shaders to `agents/swarm-outputs/claude-2026-09-14-magnetic-fractal-evolutionary-ten/card-<id>.md`:
```
SHADER: <id>
IDENTITY: ...
KEEP VERBATIM: ...
