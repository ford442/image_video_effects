...
**Current lines:** 169
**Target lines:** 219–259 (expand by +50 to +90)

## Role Instructions

You are the Optimizer. Polish the fractal rendering: interior detail, AA, and audio morphing:
...
- CAUTION: keep the smooth-iteration formula (mu = i - log2(log2|z|)) and the 3 orbit traps mathematically intact.
