# Shader Upgrade Task: `double-exposure`

## Metadata
- **Shader ID**: double-exposure
- **Agent Role**: Algorithmist
- **Current Size**: 3264 bytes
- **Target Line Count**: ~132 lines
- **Status**: pending
...
4. Ensure the upgraded shader is roughly 132 lines (±20%).
