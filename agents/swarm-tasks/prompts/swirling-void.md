# Shader Upgrade Task: `swirling-void`

## Metadata
- **Shader ID**: swirling-void
- **Agent Role**: Visualist
- **Current Size**: 2855 bytes
- **Target Line Count**: ~121 lines
- **Status**: pending
...
4. Ensure the upgraded shader is roughly 121 lines (±20%).
