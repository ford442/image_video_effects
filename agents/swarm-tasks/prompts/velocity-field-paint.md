# Shader Upgrade Task: `velocity-field-paint`

## Metadata
- **Shader ID**: velocity-field-paint
- **Agent Role**: Visualist
- **Current Size**: 3049 bytes
- **Target Line Count**: ~126 lines
- **Status**: pending
...
4. Ensure the upgraded shader is roughly 126 lines (±20%).
