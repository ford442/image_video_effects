...
```json
{
  ...
  "description": "Interactive page curl with warm/cool 3-point studio lighting on the curl face, OkLab color blending, ACES tone mapping, click shockwaves, depth-aware shadows, chromatic aberration, and temporal feedback trails.",
  "params": [
    {
      "id": "param1",
      "name": "Curl Radius",
