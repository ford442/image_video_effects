# Swarm Brief: gen-cycloid-bloom

**Role:** Visualist
**Name:** Cycloid Bloom
**Category:** generative
**Description:** Five nested hypotrochoid (Spirograph-style) curves layered into a blooming floral mandala. Each layer uses a different gear ratio that slowly evolves, petal glowing with prismatic hues that respond to audio. Feedback accumulation burns bright arcs.
**Current lines:** 133
**Target lines:** 173–223 (expand by +40 to +90)

## Role Instructions

You are the Visualist. Focus on color science, lighting, and emotional impact:
- Add HDR values >1.0, ACES tone mapping, and hue-preserving clamp before tone map.
- Use OkLab mixing, blackbody temperature shifts, or iridescent thin-film effects.
- Add atmospheric depth (fog/haze), Fresnel rim lighting, or volumetric glow.
