# Swarm Brief: gen-klein-bottle-walk

**Role:** Interactivist
**Name:** Klein Bottle Walk
**Category:** generative
**Description:** Parametric walk across a Klein bottle surface with FBM texture, diffuse/specular lighting, and audio-reactive color modulation.
**Current lines:** 148
**Target lines:** 188–238 (expand by +40 to +90)

## Role Instructions

You are the Interactivist. Focus on input reactivity, feedback loops, and emergent behavior:
- Mouse must affect at least 2 parameters (position as gravity well/attractor, click to spawn bursts/shockwaves).
- Use bass/mids/treble from plasmaBuffer; prefer attack/release envelopes stored in dataTextureA instead of raw bass.
- Add temporal feedback trails via dataTextureC → dataTextureA.
