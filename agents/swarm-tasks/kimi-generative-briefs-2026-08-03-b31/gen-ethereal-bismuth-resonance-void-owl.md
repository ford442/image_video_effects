# Swarm Brief — gen-ethereal-bismuth-resonance-void-owl (batch b31, role: visualist)

- **ID**: gen-ethereal-bismuth-resonance-void-owl
- **Name**: Ethereal Bismuth-Resonance Void-Owl
- **Category**: generative
- **Description**: A hyper-dimensional avian entity forged from iridescent bismuth lattices, suspended in a zero-gravity quantum field where sonic vibrations materialize as glowing geometric feathers.
- **Current lines**: 315  |  **Target**: 375–405 (+60 to +90)
...
1. `gen-ethereal-bismuth-resonance-void-owl.wgsl` — complete, self-contained upgraded shader (canonical header).
2. `gen-ethereal-bismuth-resonance-void-owl.json` — complete upgraded metadata.
3. `gen-ethereal-bismuth-resonance-void-owl.md` — changelog: what changed & why, loop budget/perf estimate, rating prediction.
