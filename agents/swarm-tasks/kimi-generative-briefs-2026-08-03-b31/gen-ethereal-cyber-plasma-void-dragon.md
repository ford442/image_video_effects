# Swarm Brief — gen-ethereal-cyber-plasma-void-dragon (batch b31, role: algorithmist)

- **ID**: gen-ethereal-cyber-plasma-void-dragon
- **Name**: Ethereal Cyber-Plasma Void-Dragon
- **Category**: generative
...
- **Current lines**: 294  |  **Target**: 354–384 (+60 to +90)

## Existing updatedParams (preset contract — keep names/defaults EXACTLY, indices 0-3)
  - index 0: "Plasma Intensity" default=1.5 min=0.0 max=5.0 step=0.1
  - index 1: "Dragon Undulation Speed" default=1.0 min=0.1 max=3.0 step=0.1
  - index 2: "Body Segment Density" default=20.0 min=10.0 max=40.0 step=1.0
  - index 3: "Nebula Density" default=0.8 min=0.0 max=2.0 step=0.05
...
1. `gen-ethereal-cyber-plasma-void-dragon.wgsl` — complete, self-contained upgraded shader (canonical header).
2. `gen-ethereal-cyber-plasma-void-dragon.json` — complete upgraded metadata.
3. `gen-ethereal-cyber-plasma-void-dragon.md` — changelog: what changed & why, loop budget/perf estimate, rating prediction.
