...
**Current lines:** 241
**Target lines:** 291–331 (expand by +50 to +90)
...
- CAUTION: Preserve the bitonic sorting network exactly — the bank-conflict-free shared memory structure must stay intact. Do not restructure, reorder, or 'simplify' the network stages.
