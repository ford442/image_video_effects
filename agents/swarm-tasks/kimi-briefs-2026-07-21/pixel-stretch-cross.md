# Swarm Brief: pixel-stretch-cross

**Role:** Visualist
**Name:** Pixel Stretch Cross
**Category:** interactive-mouse
**Description:** Multi-direction pixel stretch using Fibonacci disk sampling, mouse gravity well, depth-aware attenuation, bass-envelope magnitude, click shockwaves, temporal trails, and layered alpha compositing with depth fading, luminance keying, and accumulative feedback.
**Current lines:** 223
**Target lines:** 273–313 (expand by +50 to +90)

## Role Instructions

You are the Visualist. Focus on look, color, and cinematic polish:
