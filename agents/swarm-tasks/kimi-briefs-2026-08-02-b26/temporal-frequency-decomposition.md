# Swarm Brief: temporal-frequency-decomposition
...
**Current lines:** 114
**Target lines:** 164–204 (expand by +50 to +90)

## Role Instructions

You are the Algorithmist. This 8-frame temporal DFT is tagged 'mouse-driven' but NEVER reads the mouse - the pointer does nothing and clicks do nothing. Wire the interaction it advertises:
