...
**Current lines:** 176
**Target lines:** 226–266 (expand by +50 to +90)

## Role Instructions

You are the Algorithmist. This two-species SmoothLife predator-prey sim has a latent correctness bug. Fix it first, then enrich the ecosystem:
...
- CAUTION: dataTextureA carries SIM STATE (prey, predator, age, activity), NOT color - never clamp, saturate, or tonemap the A write. Preserve the 9x9 annular neighborhood convolution structure per species (expensive but intentional).
