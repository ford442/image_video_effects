# Swarm Brief: gen-rgb-diffraction

**Role:** Visualist
**Name:** RGB Diffraction
**Category:** generative
**Description:** Multi-slit diffraction grating with separate R/G/B wavelength interference, 6-fold rotational symmetry, and audio-reactive fringe modulation.
**Current lines:** 141
...
- Add atmospheric depth: volumetric light cones along slit axes, fog falloff, or Mie scattering.
- Add Fresnel/glint effects where fringes overlap.
- Add dynamic color temperature shifts driven by bass/mids/treble.
- Add bloom/glow approximation using a small radial kernel or hex-bokeh on bright fringes.
- Use OkLab or spectral wavelength mixing instead of naive RGB channel offsets.
- Preserve the original "soul" — a vivid spectral diffraction starburst.
...
```json
[
  {"index": 0, "name": "Evolution Speed", "default": 0.35, "min": 0, "max": 1, "step": 0.01},
  {"index": 1, "name": "Fringe Frequency", "default": 0.4, "min": 0, "max": 1, "step": 0.01},
  {"index": 2, "name": "Chromatic Spread", "default": 0.4, "min": 0, "max": 1, "step": 0.01},
  {"index": 3, "name": "Brightness", "default": 0.5, "min": 0, "max": 1, "step": 0.01}
]
```
