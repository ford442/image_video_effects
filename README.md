...
A React + WebGPU app for real-time GPU shader effects — fluids, generative art, audio-reactive visuals, AI depth estimation, and a catalog of **1,369** compute shaders across 14 categories.
...
- **1,369 shader effects** — counts from `public/shader-manifest-unified.json` (regenerate: `npm run build:manifest`; gate: `npm run verify:catalog-counts`)
...
|----------|------:|-------------|
| **generative** | 474 | Procedural art, fractals, generative patterns |
...
| **Total** | **1,369** | 14 canonical categories |
...
│   ├── shaders/                    # WGSL compute shaders (1,369 catalog ids; more pass files on disk)
