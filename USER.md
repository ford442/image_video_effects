...
- **Timezone:**
- **Blackbody / thermal eight (2026-09-15):** Spec Blackbody Thermal, Chroma Kinetic, Thermal Vision, Thermal Touch, Stellar Plasma, Singularity Forge, Heat Haze, and Gamma-Ray Burst. Two native ideas each (depth conduction, Wien fringe, heat split, gradient axis, isotherm bands, NETD grain, conduction halo, ember streaks, spectral classes, differential shear, redshift, doppler beaming, vorticity, mirage band, afterglow, light-curve flicker); identities kept; stellar/singularity config.y/z/w audio lies fixed to plasmaBuffer; chroma dataTextureA write added; no new springs. Cards: `agents/swarm-outputs/muse-2026-09-15-blackbody-thermal-eight/`.
