...
- **Batch 71 generative-only:** Cybernetic Mycelium, Cyclic Automaton, Cycloid
  ...
  remains external.
- **Current mycelium leftover cohort:** Complete (2026-09-13). Tropism-rich `mycelium-network` still skipped. Physarum extraBuffer[0..] agents still skipped. Grok-1 fireworks/grid leftover list is complete (stale). Grok-1 ice/Julia simpler-gen ten is complete (5 skip + 5 upgrade). Next clean leftover: remaining classic math/CA (rgb-diffraction / Langton / Klein / Verlet cloth / Koch / phyllotaxis / Sierpinski tet / Newton), or `crt-clear-zone`, liquid-small, or the blackbody Phase-C ten. Mandelbox-explorer and magnetic-field-warp were carded 2026-09-14. Lighting/geometric/hybrid/sim leftovers from the 09-09 foundation note are done.
