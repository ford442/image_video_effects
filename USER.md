...
- **Batch 71 generative-only:** Cybernetic Mycelium, Cyclic Automaton, Cycloid
  ...
  remains external.
- **Current simulation leftover cohort:** Complete (2026-09-12). Next clean leftover: sand / slime / physarum / wave-equation (still no Idea Cards). Lighting/geometric/hybrid leftovers from the 09-09 foundation note are done.
