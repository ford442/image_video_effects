...
- **Batch 71 generative-only:** Cybernetic Mycelium, Cyclic Automaton, Cycloid
  ...
  remains external.
- **Current mycelium leftover cohort:** Complete (2026-09-13). Tropism-rich `mycelium-network` still skipped. Physarum extraBuffer[0..] agents still skipped. Grok-1 fireworks/grid leftover list is complete (stale). Grok-1 ice/Julia simpler-gen ten is complete (5 skip + 5 upgrade). Classic math/CA leftover six carded 2026-09-15 (rgb-diffraction, verlet-cloth-wind, sierpinski-tetrahedron, cellular-automata-tapestry, turing-morphogenesis, buddhabrot-aura). Remaining uncarded of that family after 09-14/09-15: skip percolation extraBuffer[0..] (already carded), skip BZ/protocell/hyperbolic-tree as idea-rich metadata. Next clean leftover: `crt-clear-zone`, liquid-small, or the blackbody Phase-C ten. Lighting/geometric/hybrid/sim leftovers from the 09-09 foundation note are done.
