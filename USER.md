...
- **#1228 style.css split (2026-09-13):** `src/style.css` is a barrel. Sheets: `styles/layout.css`, `controls.css` (sidebar/forms/status/remote), `webcam.css`, `roulette.css`, `storage-modal.css` — all under 700. Import order preserved. `gold-glass-theme.css` (717) left as-is. SKIP_WASM_BUILD=1 build green. No GPU visual QA here.
...
- **Batch 71 generative-only:** Cybernetic Mycelium, Cyclic Automaton, Cycloid
  ...
  remains external.
- **Current origami / lichen / bio leftover cohort:** Complete (2026-09-12). Kaleido/drag eights and origami/crease/ascii already had 09-11 Idea Cards. Cyber-EM hybrid ten from conflicting PR #1247 landed 2026-09-13. Physarum extraBuffer[0..] agents still skipped. Next clean leftover: remaining mycelium companions that are not already tropism-rich, a CRT leftover, the liquid-small cluster, or the blackbody cluster. Lighting/geometric/hybrid/sim leftovers from the 09-09 foundation note are done.
